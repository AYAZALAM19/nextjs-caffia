...
const BrightInfiniteSlider = () => {
  ...
  return (
    <section className="relative mx-auto w-full lg:h-[500px] h-[300px] lg:block hidden overflow-hidden bg-gradient-to-b from-amber-200 via-white/5 to-transparent  group">
      {/* Slides */}
      <div
        ref={sliderRef}
          ...
          <div key={index} className="relative w-full h-full min-w-full">
            ...
            <div className="absolute inset-0 flex items-center px-6 md:px-12 lg:px-16">
              <div className="max-w-2xl space-y-6">
                {/* Title */}
                <h1
                  className={`text-3xl md:text-5xl lg:text-6xl font-bold text-caffia leading-tight drop-shadow-lg transition-all duration-700 ease-out ${
                ...
                {/* Subtitle */}
                <p
                  className={`text-lg md:text-xl lg:text-2xl text-white/95 leading-relaxed drop-shadow-md transition-all duration-700 ease-out delay-200 ${
                    Math.abs(currentIndex - index) === 0
                      ? "translate-x-0 opacity-100"
                      : "translate-x-[-50px] opacity-0"
                  }`}
